...
* File Name : clientWrapUdp.c

* Purpose : Networks Assignment

* Creation Date : 29-01-2013

* Last Modified : Thursday 07 February 2013 12:13:24 AM IST
        ...
        while(cnt < MAX_TRY){
            if(prob*1000 < rand()%1000){
                ...
                if(prob*1000 < rand()%1000){
                    ...
                    printf("Try #%d: Packet dropped; Packet not received\n", cnt++);
                    continue;
                }
            }
            else{
                printf("Try #%d: Packet dropped; Packet not sent\n", cnt++);
                continue;
            }
        }
        if(cnt == MAX_TRY){
